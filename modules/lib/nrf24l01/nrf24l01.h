 ...
 * полезной нагрузки вызовом nrf24l01_read_pld_size() перед считыванием,
...
struct nrf24l01_pipe_config {
    ...
    /**
     * Размер пакетов, принимаемых по этому соединению. Должен находиться
     * в пределах от 1 до 32 байт. Это поле не имеет значения,
     * если используется хотя бы одна из расширенных возможностей соединения.
     */
    uint8_t pld_size;
    /**
 ...
 */
bool nrf24l01_tx_fifo_is_full(void);
