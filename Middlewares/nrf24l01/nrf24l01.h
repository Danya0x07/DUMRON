 ...
 *          и NRF24L01+.
 *
 * На текущий момент поддерживается работа только с единственным физическим
 * экземпляром трансивера.
 *
...
enum nrf24l01_pipe_mode {
     ...
     * нагрузкой, то, даже если размер принимаемых данных постоянен, нужно
     * использовать режим @ref NRF24L01_PIPE_MODE_ACK_DPL.
     */
